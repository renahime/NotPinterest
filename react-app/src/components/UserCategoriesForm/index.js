...
export default function UserCategoriesForm() {
    ...
    let bohoImageClassName = bohoImage ? "selected-user" : "notSelected"
    let athleisureImageClassName = athleisureImage ? "selected-user" : "notSelected"
    let darkImageClassName = darkImage ? "selected-user" : "notSelected"
    let formalImageClassName = formalImage ? "selected-user" : "notSelected"
    let oldMoneyImageClassName = oldMoneyImage ? "selected-user" : "notSelected"
    let streetwearImageClassName = streetWearImage ? "selected-user" : "notSelected"
